...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        public Text text2;
        public Text text3;
        public Text textbottle;
        private int numbercube;
        public Animator moveclock;

        public Text helpText;
        public Text pleaseText;

        public AudioSource clock_down_music;
        ...
        private void Start()
        {
            ...
            textbottle.gameObject.SetActive(false);
            numbercube = 0;
        ...
        {
            if (other.gameObject.CompareTag("alchole"))
            {
             

           
                textbottle.gameObject.SetActive(true);
                Destroy(other);
            }

            if (other.gameObject.CompareTag("clock"))
            {
                clock_down_music.Play();
                
                moveclock.SetBool("move", true);
                text3.gameObject.SetActive(true);
                Destroy(other);
            }
            if (other.gameObject.CompareTag("bubble-door"))
            {
